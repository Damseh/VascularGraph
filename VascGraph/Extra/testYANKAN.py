...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov 26 13:04:46 2018
...
if __name__=="__main__":
    ...
    # read origional seg
    foldername='/home/rdamseh/YanKan/YanKan/NewOnes/'
    filename='labels_74AK_volume_520nm_2'
    
    try:
        label=sio.loadmat(foldername+filename)['seg']
    except:
        label=readStack(foldername+filename+'.tif') 
        s={'seg':label>0}
        sio.savemat(foldername+filename+'.mat', s,  do_compression=True)
